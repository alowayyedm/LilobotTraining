...
//     * direction the modification is intended, which are the valid phases to transition to,
//     and the value if the belief
...
//            case "request_chitchat_goodbye" -> graphUtils.setBeliefValue(BeliefName.B15, beliefs, maxValue);
...
//            }
//            //added new case
//            case "request_confidant_when", "request_confidant_feeling",
//                    "request_confidant_how", "request_confidant_say" ->
//                    graphUtils.increaseBeliefValue(BeliefName.B2, beliefs, oneStep);
//            case "request_goal_dream" -> graphUtils.setBeliefValue(BeliefName.B11, beliefs, maxValue);
...
//                }
//            }
//            case "request_confidant_who" -> graphUtils.setBeliefValue(BeliefName.B12, beliefs, maxValue);
