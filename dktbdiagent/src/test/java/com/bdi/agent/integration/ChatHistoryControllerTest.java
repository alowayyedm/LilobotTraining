...
public class ChatHistoryControllerTest {
    ...
    public void getChatHistoryMetadataListTest() throws Exception {
        Agent agent = new Agent(1L, "testId", null, null, Phase.PHASE1, 1L, "", true, 1L, 1f, null, false, null);
        User user = new User(1L, "j_doe", "1VeryUnsafePassword!", "j.doe@mail.com", Role.LEARNER, null, null, 0);
        ...
        MvcResult result = resultActions.andExpect(status().isOk())
                .andExpect(handler().methodCall(on(ChatHistoryController.class).getChatHistoryMetaDataByUser("j_doe")))
                .andReturn();
