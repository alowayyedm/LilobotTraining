...
public class AgentServiceTest {
    ...
    public void updateBeliefValid() {
        Agent agent = new Agent(1L, "testId", "testKnowledge", null, null, null, null, null, 0L, "", true, 0L, 0.0f, null, false, null);
    ...
    public void setManualValidFalse() {
        Agent agent = new Agent(1L, "testId", "knowledge", null, null, null, null, null, 0L, "", true, 0L, 0.0f, null, true, null);
        when(mockAgentRepository.existsByUserId("testId")).thenReturn(true);
        when(mockAgentRepository.getByUserId("testId")).thenReturn(agent);
        agentService.setTrainerResponding("testId", false);
        ArgumentCaptor<Agent> argumentCaptor = ArgumentCaptor.forClass(Agent.class);
    ...
    public void addLogValidLilo() {
        ...
        Agent agent = new Agent(1L, "testId", "knowledge", null, null, null, null, null, 0L, "", true, 0L, 0.0f, new ArrayList<>(), true, null);
        when(mockAgentRepository.existsByUserId("testId")).thenReturn(true);
        when(mockAgentRepository.getByUserId("testId")).thenReturn(agent);
    ...
    public void reasonTest() {
        Agent agent = new Agent(1L, "testId", "test", null, null, null, null, null, 0L, "", true, 0L, 0.0f, new ArrayList<>(), false, null);
    ...
    public void addDesireUpdateLogTest() {
        Agent agent = new Agent(1L, "testId", "testKnowledge", null, null, null, null, null, 0L, "", true, 0L, 0.0f, new ArrayList<>(), false, null);
    ...
    public void testSetAgentToPhaseValid() throws Exception {
        ...
        Agent agent = new Agent(1L, "testId", "test", beliefs, null, null, null,  Phase.PHASE1, 0L,
