...
public class OptimalPathServiceTest {
    ...
    public void testGenerateOptimalPathRequestNull() {
        ...
        Agent agent = new Agent(1L, "testId", "test", null, null, null, null, null, 0L, "", true,
    ...
    public void testInitGraphFromAgent() {
        ...
        Agent agent = new Agent(1L, "testId", "test", beliefs, desires, null, null, null, 0L, "subject", true,
                0L, 0.0f, null, false, null);
